...
const FileText = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14,2 14,8 20,8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg>
);
...
Taraflar arasında doğabilecek uyuşmazlıklar öncelikle müzakere yoluyla çözülmeye çalışılır. Anlaşma sağlanamaması durumunda Türkiye Cumhuriyeti mahkemeleri yetkilidir.`,
  },
  {
    ...
    content: `Verimio, bu Kullanım Şartlarını önceden haber vermeksizin güncelleme hakkını saklı tutar. Önemli değişiklikler olduğunda aktif kullanıcıları e-posta ile bilgilendiririz.
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-4">
                Kullanım{" "}
                <span className="text-foreground">Şartları</span>
              </h1>
