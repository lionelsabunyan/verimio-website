...
export default function DiscoveryIcon({ className = "", size = 24 }: IconProps) {
  return (
    ...
    >
      ...
      {/* Top arrow */}
      <path d="M 12 5.5 L 12 3.5" stroke="#F59E0B" strokeWidth="1.5" />
      <path d="M 11 4.5 L 12 3.5 L 13 4.5" stroke="#F59E0B" strokeWidth="1.2" />
      {/* Bottom arrow */}
      ...
      {/* Right arrow */}
      <path d="M 17.5 12 L 19.5 12" stroke="#F59E0B" strokeWidth="1.5" />
      <path d="M 18.5 11 L 19.5 12 L 18.5 13" stroke="#F59E0B" strokeWidth="1.2" />
    </svg>
  );
}
