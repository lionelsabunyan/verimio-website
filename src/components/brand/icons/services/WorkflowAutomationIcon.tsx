...
export default function WorkflowAutomationIcon({ className = "", size = 32 }: IconProps) {
  return (
    ...
    >
      ...
      <circle cx="26" cy="24" r="3.5" stroke="#FFD93D" strokeWidth="1.5" fill="#FFD93D" fillOpacity="0.15" />
      ...
      <path d="M 9.5 24 Q 16 24 22.5 24" stroke="#FFD93D" strokeWidth="1.2" strokeOpacity="0.6" />
      <path d="M 26 11.5 Q 26 16 26 20.5" stroke="#FFD93D" strokeWidth="1.2" strokeOpacity="0.6" />
      ...
      <path d="M 23.5 24 L 25.5 26 L 28.5 22" stroke="#FFD93D" strokeWidth="1.5" />
    </svg>
  );
}
