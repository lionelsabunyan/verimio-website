...
export default function ROIIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none"
      ...
      {/* Rising line */}
      <path d="M 4 18 Q 10 16 14 12 Q 17 9 20 6" stroke="#FFD93D" strokeWidth="1.5" fill="none" />
      {/* End point */}
      <circle cx="20" cy="6" r="2" fill="#FFD93D" fillOpacity="0.7" stroke="#FFD93D" strokeWidth="1" />
      {/* Up arrow */}
      <path d="M 18 5 L 20 3 L 22 5" stroke="#FFD93D" strokeWidth="1.2" />
    </svg>
  );
}
